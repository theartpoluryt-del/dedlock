...
struct PlayerData { Vector3 pos; Vector3 headPos; Vector3 bodyPos; bool hasHeadBone=false; bool hasBodyBone=false; std::vector<BoneSegment> bones; float boxLeft,boxTop,boxRight,boxBottom; float modelMinZ,modelMaxZ,modelHeight; int health,maxHealth,team; float distance; std::string heroName; };
...
extern uintptr_t clientBase; extern bool menuOpen,drawEsp,drawBoxes,drawHealth,drawHealthValues,drawNames,drawDistance,drawSnaplines,drawFovCircle,drawFarmFovCircle,drawBones,farmAssist,autoLastHitOrbs,drawOrbEsp,glowEnabled,aimAssist,autoParry,imguiInitialized,consoleAttached; extern float fovCircleAlpha,farmFov,farmFovAlpha,snaplineAlpha; extern int aimAssistKey,farmAssistKey; extern bool aimKeyCapture,farmKeyCapture; extern Vector3 currentLocalPosition; extern bool currentLocalPositionReady; extern Vector3 currentCameraPosition; extern bool currentCameraPositionReady; extern uintptr_t currentLocalPawn; extern uint32_t currentLocalPawnHandle; extern std::mutex meleeObjectsMutex; extern std::vector<uintptr_t> meleeObjects; extern std::mutex silentAnglesMutex; extern Vector3 pendingSilentAngles; extern bool pendingSilentAnglesReady,pendingSilentAttack; extern std::mutex farmTargetsMutex; extern std::vector<FarmTarget> farmTargets; extern std::mutex orbTargetsMutex; extern std::vector<OrbTarget> orbTargets;
extern float aimFov,aimSmooth,farmAimSmooth; extern bool aimVisibilityCheck,aimToggleMode,aimToggleActive,aimToggleLastDown,farmSilentMode; extern ID3D11Texture2D* depthStaging; extern UINT depthWidth,depthHeight; extern DXGI_FORMAT depthFormat; extern bool depthSnapshotReady; extern int depthDiagnosticState; extern Matrix4x4 currentViewMatrix; extern bool currentViewMatrixReady;
